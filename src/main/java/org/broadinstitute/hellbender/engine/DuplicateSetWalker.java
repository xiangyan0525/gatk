...
public abstract class DuplicateSetWalker extends ReadWalker {
    ...
    private ReadsWithSameUMI currentReadsWithSameUMI = null;
    ...
    /**
     * Process the very last read set, as in apply() we cannot know whether the read we're looking at
     * is the very last read in the input bam.
     */
    @Override
    protected final void finalizeTraversal(){
