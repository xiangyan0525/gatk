...
public class DownsampleByDuplicateSetTest extends CommandLineProgramTest {
    public static final String downsampleByDuplicateSetTestDir = publicTestDir + "org/broadinstitute/hellbender/tools/downsampleByDuplicateSet/";
    public static final String NA12878_GROUPED = downsampleByDuplicateSetTestDir + "NA12878.grouped.bam";
